...
def showMapVisdom(m,viz=None,folder_name=None,generated=False,win_name=None,epoch=None) :
    if generated :
        ...
        ints = m.getTileMap()
    im = getMapImage(ints)
    if folder_name : im.save('{}{}/outputs/out_{}.png'.format(path_experiments, folder_name, epoch), 'PNG')
    if viz :
